...
class Visualizer:
    ...
    def set_gt_box(self, box_list):
        self.draw_box(self.gt_line_set, box_list, is_gt=True)

    def set_dt_box(self, box_list):
        self.draw_box(self.dt_line_set, box_list)
